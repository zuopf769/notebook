...
$.matchMedia = (function () {
    var mediaId = 0;
    var cls = 'sf-edu-wenku-gmu-media-detect';
    var transitionEnd = $.fx.transitionEnd;
    var cssPrefix = $.fx.cssPrefix;
    var $style = $('<style></style>').append('.' + cls + '{' + cssPrefix + 'transition: width 0.001ms; width: 0; position: absolute; clip: rect(1px, 1px, 1px, 1px);}\n')
         .appendTo($(vw.container).find('.sfa-head'));
    ...
    return function (query) {
        ...
        $style.append('@media ' + query + ' { .sf-edu-wenku-id-' + id + ' { width: 1px; } }\n'); // 原生matchMedia也需要添加对应的@media才能生效
        ...
        $mediaElem = $('<div class="' + cls + ' sf-edu-wenku-id-' + id + '"></div>')
            .appendTo(vw.container)
